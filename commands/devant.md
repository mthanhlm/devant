...
graph, push back if it's debt-prone or contradicts recorded intent, size by blast radius, and
dispatch to the right specialist — do not inline substantial work.
